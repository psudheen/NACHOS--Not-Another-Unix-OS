...
void CarlJrSimulation (void)
{
    ...
    ***************************************************************************************/
		...
		SigCustList[3]=CreateMV("S4",2);
		SigCustList[4]=CreateMV("S5",2);
...
CustData[0].TypeOfFood=CreateMV("CD0",3);
		...
		EatInCustWaitingForFood[4]=CreateMV("EC4",3);
		...
		ToGoCustWaitingForFood[4]=CreateMV("TC4",3);
		...
		GrabedFood[3][0]=CreateMV("GF30",4);
		GrabedFood[3][1]=CreateMV("GF31",4);
		GrabedFood[3][2]=CreateMV("GF32",4);
		GrabedFood[3][3]=CreateMV("GF33",4);
		GrabedFood[3][4]=CreateMV("GF34",4);

		GrabedFood[4][0]=CreateMV("GF40",4);
		GrabedFood[4][1]=CreateMV("GF41",4);
		GrabedFood[4][2]=CreateMV("GF42",4);
		GrabedFood[4][3]=CreateMV("GF43",4);
		GrabedFood[4][4]=CreateMV("GF44",4);
    ...
    ***************************************************************************************/
    ...
    /*CookStyle[4][40]={"$6 Burger","$3 Burger","Veggie Burger","French Fries"};*/
		SetMV(CookedFood[0],0);
		SetMV(CookedFood[1],0);
		SetMV(CookedFood[2],0);
		SetMV(CookedFood[3],0);
		...
		SetMV(OrderTakerStatus[3],BUSY);
		SetMV(OrderTakerStatus[4],BUSY);
    ...
    ***************************************************************************************/
    ...
    custLineLock=CreateLock("CD",2);
		...
		OrderTakerLock[3]=CreateLock("OL3",3);
		OrderTakerLock[4]=CreateLock("OL4",3);
    ...
    ***************************************************************************************/
    ...
    WaitersCV=CreateCondition("WJ",2);
		...
		OTWaitingCV[3]=CreateCondition("OC3",3);
		OTWaitingCV[4]=CreateCondition("OC4",3);
